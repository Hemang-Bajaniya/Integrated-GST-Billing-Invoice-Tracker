...
public partial class GstInvoiceTrackerDbContext : DbContext
{
    ...
    {
        // Only configure if NOT already configured by DI (Program.cs AddDbContext).
        // This prevents the hardcoded scaffold string from overriding appsettings.json.
        if (!optionsBuilder.IsConfigured)
        {
            optionsBuilder.UseMySql(
                "server=localhost;port=3306;database=gst_billing_db_init;uid=root;password=",
