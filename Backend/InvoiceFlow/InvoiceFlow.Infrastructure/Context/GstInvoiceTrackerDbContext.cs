...
namespace InvoiceFlow.Infrastructure.Context;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AuthUser>(entity =>
        {
            ...
            entity.Property(e => e.Status)
                ...
                .HasColumnType("enum('Active','PendingApproval','Rejected')")
        ...
        modelBuilder.Entity<Invitation>(entity =>
        {
            ...
            entity.HasIndex(e => e.InvitedBy, "fk_inv_admin");

            entity.HasIndex(e => e.InvitedUserId, "fk_inv_user");

            entity.HasIndex(e => e.BusinessProfileId, "idx_inv_biz");

            entity.HasIndex(e => e.Status, "idx_inv_status");

            entity.HasIndex(e => e.Token, "idx_inv_token").IsUnique();
            ...
            entity.Property(e => e.Status)
                ...
                .HasColumnType("enum('Pending','Accepted','Approved','Rejected')")
                .HasColumnName("status");
            ...
            entity.HasOne(d => d.BusinessProfile).WithMany(p => p.Invitations)
                .HasForeignKey(d => d.BusinessProfileId)
                .HasConstraintName("fk_inv_business");

            entity.HasOne(d => d.InvitedByNavigation).WithMany(p => p.InvitationInvitedByNavigations)
                .HasForeignKey(d => d.InvitedBy)
                .HasConstraintName("fk_inv_admin");
